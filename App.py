...
def main(): 
    ...
    if app_mode == "App Source Code":
        ...
        if col1.button('הטיה'):
              ...
              st.write("--------------------------------------------------------------")
              st.markdown("<h5 style='text-align: right;'>פורום לתשתיות לאומיות  למחקר ופיתוח ועדת בינה מלאכותית ומדע הנתונים (2020)(2)</h5>", unsafe_allow_html=True)
	      ...
	      st.markdown("<h5 style='text-align: right;'>(10)ועדת בינה מלאכותית ומדע הנתונים, לעיל ה'ש 2</h5>", unsafe_allow_html=True)
	      st.markdown("<h5 style='text-align: right;'>(11)שם</h5>", unsafe_allow_html=True)
