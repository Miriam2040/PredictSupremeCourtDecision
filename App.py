...
def main(): 
    ...
    if app_mode == "App Source Code":
        ...
        st.markdown("<h4 style='text-align: right;'>(1)תחילה, ארצות הברית הפעילה מספר מחקרים שתפקידם הוא מיקסום השילוב בין טכנולוגיה ומוסר. כך כבר בשנת 2018, דארפ'א במסגרת תוכנית הסברתית, ניסתה לעזור למשתמשים להבין את אופן קבלת ההחלטות של מערכות הבינה המלאכותית, זאת ללא פגיעה ברמת הביצוע של המערכות. בנוסף ניתן לראות מחקר של הקרן הלאומית למדע יחד עם אמזון, שמטרתו היא מיקוד בהוגנות מערכות הבינה המלאכותית, ולשם כך הם חקרו מספר סוגיות: שקיפות, הסברתיות, אחריות, פוטנציאל להטיה, השפעות שליליות, התקדמות אלגוריתמית ויעדי הגינות</h4>", unsafe_allow_html=True)
