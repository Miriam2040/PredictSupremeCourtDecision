...
def main(): 
    ...
    if app_mode == "App Source Code":
        ...
        if col2.button('פרטיות'):
              st.markdown("<h4 style='text-align: right;'>זכותו של אדם לפרטיות קשורה בין היתר לכיבוד האוטונומיה שלו ויכולתו לבחור כיצד לפעול בחייו. כאשר עסקינן בפרטיות במידע, במרכז עומדת זכותו של אדם לשלוט או להשפיע על המידע אודותיו. בעידן הנוכחי בו איסוף המידע אודותינו מתרחשת בכל רגע, ברחבי העולם כולו, ללא שליטה וכמעט ללא הגבלה. המידע הנאסף עשוי לשמש יסוד להפקת מידע אודות אדם ללא קשר בהכרח למקור. בנוסף ניתן להשתמש במידע להשפעה לא הוגנת על הפרט. לכן עולים אתגרים רבים להגנה על הזכות לפרטיות של הפרט. בדומה לכך פועלות מערכות הבינה המלאכותית, הן מבוססות על עיבוד נתונים, ממקורות שונים, לעיתים תוך ניתוק מההקשר המקורי בגינו הוא נאסף. בנוסף המערכות מסיקות מסקנות, מקבלות החלטות ומבצעות פעולות על בסיס מידע זה. כך נוצר סיכון מהותי לפגיעה בזכות לפרטיות</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>ארצות הברית</h3>", unsafe_allow_html=True)
              st.markdown("<h4 style='text-align: right;'>ניתן לראות כי הזכות לפרטיות לא מעוגנת באופן חד משמעי בחוקה של ארצות הברית, אם זאת התיקון התשיעי לחוקה קובע כי אין לפרש את החוקה המונה זכויות אדם אשר ראוי להגן עליהם כרשימה סגורה.   ואכן ניתן לראות כי במהלך השנים נעשה שימוש בתיקון זה כדי לבסס את ההגנה על הפרטיות של הפרט. בנוסף החוקה של ארצות הברית מכילה הגנה משמעותית מפני חיפוש בלתי סביר, שזו היא כאמור נגזרת של הזכות לפרטיות ובית המשפט העליון הרחיב את ההכרה בזכות זו למלוא היקפה של הזכות.  חשוב לציין כי הרבה מן המדינות בארצות הברית לא הסתפקו בהחלה פדרלית ועיגנו את הזכות לפרטיות על כל גווניה בחוקה המדינית. בעניינו חשוב לציין את עניין כץ  בו נקבע כי פעולות הממשל מוגבלות במקום בו יש לפרט 'ציפיה סבירה' לפרטיות. הזכות לפרטיות מתבטאת גם בזכותו של אדם לאוטונומיה של הפרט, כאשר ההחלטה הראשונה בתחום התקבלה בעניין  גריסוולד נגד קונטיקט בו נקבע כי לא ניתן לאסור על מכירה של אמצעי מניעה, פסק דין זה קבע כי הזכות לפרטיות מעוגנת בחוקה של ארצות הברית.  בנוסף הפסיקה האמריקאית הכירה בפרטיות נזיקית אשר מטרתה העיקרית היא מניעה של זליגת המידע של הפרט, זכות זו אינה ייחודית ליחסי אזרח־שלטון, אלא זכות אזרחית</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>ישראל</h3>", unsafe_allow_html=True)
              st.markdown("<h4 style='text-align: right;'>הזכות לפרטיות לא הוכרה תחילה ע'י בית המשפט,  אך נראה תפנית בסוף שנות ה-70 בעניין קטלן.  בהמשך בשנת 1981 חוקק חוק הגנה הפרטיות,  אשר קובע כי פגיעה בפרטיות מהווה עבירה פלילית ועוולה אזרחית, ובית המשפט קבע כי הזכות לפרטיות היא זכות יסוד שאין לפגוע בה.  מאוחר יותר הזכות לפרטיות קיבלה  עיגון רשמי כזכות יסוד מכוח חוק יסוד: כבוד האדם וחירותו, כאשר סעיף 7 לחוק קובע</h4>", unsafe_allow_html=True)
              ...
              st.markdown("<h4 style='text-align: right;'>בעניינו רלוונטי לדון בזכות לפרטיות במידע, קיימת הסכמה כללית כי לבני האדם ישנה ציפייה לגיטימית שמידע על חייהם האישיים לא יהיה חשוף לעייני כל.  התפתחותו של העידן הטכנולוגי מחריפה את בעיית המידע, וניתן לראות אזכור לכך בפסקותיו של בית המשפט העליון, כאשר השופטת בייניש מדגישה את משנה הזהירות שיש לנקוט, כאשר התקדמות הטכנולוגיה מובילה לפגיעה בזכות לפרטיות.  בנוסף ניתן לראות אזכור לחשיבותה של הזכות לפרטיות בעניין האיכונים,  הנשיאה חיות מאזכרת את הש' סולברג באמרו: ' המשטר הדמוקרטי דורש אף הוא את קיומה של הזכות לפרטיות. קיומו של מרחב חיים פרטי שלא נמצא תחת עינה הפקוחה של המדינה, הוא הכרחי לקיומה של חברה פלורליסטית המעניקה דרור למגוון הקולות בקִרבּה'. חשוב לציין כי על אף עיגונה של הזכות לפרטיות בחוק הגנת הפרטיות,  אשר מונה 11 מעשים אשר יחשבו לפגיעה בזכות ובנוסף עיגונה בחוק יסוד, הדגיש בית המשפט כי היקפה של הזכות אינו מוגדר ומשתנה בהתאם למציאות</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>לכם זה לא יקרה</h3>", unsafe_allow_html=True)
        ...
        if col3.button('לשון הרע'):
              st.markdown("<h4 style='text-align: right;'>כאשר עסקינן בדיני לשון הרע, ניתן לראות את הצורך לאזן בין שני ערכים בסייסים באנושות, הזכות לכבוד אל מול חופש הביטוי. איזון זה משתנה בין חברה לחברה, ובין מערכות משפט שונות. אי לכך דיני לשון הרע הם תחום דימי ומתפתח, וניתן לראות את ניסיון ההשפעה על נקודת איזון זו מצידו של בית המשפט והמחוקק</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>ארצות הברית</h3>", unsafe_allow_html=True)
              st.markdown("<h4 style='text-align: right;'>מקורם של דיני לשון הרע בארצות הברית הוא מהמשפט המקובל, הנקלט ביבשת אמריקה עוד בתקופת השלטון הבריטי. לאחר ייסודה של ארצות הברית והחוקה הפדרלית ניתן לראות שינוי, שכן התיקון הראשון לחוקה קובע הגנה מהותית על הזכות לחופש הביטוי. האיזון בין הזכות לחופש הביטוי לבין הזכות לשם טוב הוא סוגיה מהותית המשתנה בין שיטות משפט שונות. כאמור ניכר כי בארצות הברית, כאשר אין חשש לאלימות, זכותו של אדם לחופש הביטוי גוברת. עם זאת ניתן לראות כי עידן האינטרנט מביא עימו שינוי, כאשר ישנה עלייה במספר ההליכים הפליליים כאשר עסקינן בהוצאת דיבה באינטרנט, זאת בעזרת חוקים מדיניים שניתן למצוא במספר מדינות (בקולורדו, בפלורידה, באיידהו, בקנזס, בלואיזיאנה, במישיגן במינסוטה, במונטנה, בניו-המפשייר, בניו-מקסיקו, בצפון קרולינה, בצפון דקוטה, באוקלהומה, ביוטה, בווירג'יניה, בוושינגטון ובוויסקונסין, וכן בפורטו ריקו ובאיי הבתולה)</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>ישראל</h3>", unsafe_allow_html=True)
              st.markdown("<h4 style='text-align: right;'>כבוד האדם ושמו הטוב חשובים לאדם כחיים עצמם. הם יקרים לנו ולרוב יותר מכל נכס אחר'.  בישראל ניתן לראות כי זכותו של אדם לשמו הטוב מעוגנת בחוק איסור לשון הרע,  אשר מהווה עוולה פלילית מכוח סעיף 6 ועוולה אזרחית מכוח סעיף 7. חשוב לציין כי בעידן האינטרנט ישנה חשיבות מיוחדת להגנה על הזכות לשם טוב, כאשר בית המשפט דן רבות במאפייניו הייחודיים של האינטרנט בהקשר של חופש הביטוי.  בנוסף ניתן לראות כי הפסיקה העניקה לזכות לשם טוב עיגון בחוד יסוד: כבוד האדם חירותו, שכן שמו הטוב של אדם טבוע אינהרנטית במושג כבוד האדם'</h4>", unsafe_allow_html=True)
              st.markdown("<h3 style='text-align: right;'>לכם זה לא יקרה</h3>", unsafe_allow_html=True)
        ...
        st.markdown("<h4 style='text-align: right;'>(1)תחילה, ארצות הברית הפעילה מספר מחקרים שתפקידם הוא מיקסום השילוב בין טכנולוגיה ומוסר. כך כבר בשנת 2018, דארפ'א במסגרת תוכנית הסברתית, ניסתה לעזור למשתמשים להבין את אופן קבלת ההחלטות של מערכות הבינה המלאכותית, זאת ללא פגיעה ברמת הביצוע של המערכות. בנוסף ניתן לראות מחקר של הקרן הלאומית למדע יחד עם אמזון, שמטרתו היא מיקוד בהוגנות מערכות הבינה המלאכותית, ולשם כך הם חקרו מספר סוגיות: שקיפות, הסברתיות, אחריות, פוטנציאל להטיה, השפעות שליליות, התקדמות אלגוריתמית ויעדי הגינות(1)</h4>", unsafe_allow_html=True)
        st.markdown("<h4 style='text-align: right;'>(2)באוקטובר 2019 פרסמה הוועדה המייעצת לחדשנות וביטחון (Defense Innovation board) המלצות לשימוש אתי בבינה מלאכותית. ההמלצות כוללות חמישה עקרונות אתיים לייצור טכנולוגיות המבוססות על בינה מלאכותית: אחריות, שוויון, יכולות מעקב והבנה של הטכנולוגיה, אמינות ויכולת משילות. בנוסף המסמך מספק המלצות בתחום בניהן: הרחבת המחקר להטמעה ראויה של עקרונות אתיים, השקעה במחקר, הגדרת מדדים לאמינות מערכות בינה מלאכותית, יצירת טכניקות להערכה של מערכות בינה מלאכותית, ומחקר ספציפי בתחומי האבטחה</h4>", unsafe_allow_html=True)
        st.markdown("<h4 style='text-align: right;'>(3)מאוחר יותר בתחילת שנת 2020 פורסמו קווים מנחים לרגולציה על מערכות בינה מלאכותית, על ידי הבית הלבן. כאשר במרכז עמד הרצון ליצור גישות אמינות לאימות מערכות המבוססות על בינה מלאכותית. הקווים המנחים כוללים מספר עקרונות אשר צריכים לבסס את הרגולציה בתחום: אמון הציבור בבינה מלאכותית, שיתוף הציבור, יושרה מדעית ואיכות מידע, הערכת וניהול סיכונים, עלות ותועלת, גמישות, הוגנות ואי אפליה, גילוי נאות ושקיפות להגברת אמון הציבור, בטיחות וביטחון ותיאום בין סוכנויות. לצד העקרונות הרגולטורים ישנם עקרונות לא רגולטורים להטמעת הבינה המלאכותית בצורה הטובה ביותר: יצירת תוכניות וניסויים לשם פיתוח סטנדרטים וולונטריים  שיאפשרו ניהול סיכוני פיתוח באופן אדפטיבי יותר. לקראת סוף אותה שנה פרסמו הנחיות לממשל הפדרלי כדי לאפשר שימוש אמין במערכות בינה מלאכותית</h4>", unsafe_allow_html=True)
        st.write("--------------------------------------------------------------") 
