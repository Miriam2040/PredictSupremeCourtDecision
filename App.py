...
def main(): 
    ...
    if app_mode == "App Source Code":
        ...
        if col1.button('הטיה'):
              ...
              st.write("--------------------------------------------------------------")
              st.markdown("<h5 style='text-align: right;'>(2)פורום לתשתיות לאומיות  למחקר ופיתוח ועדת בינה מלאכותית ומדע הנתונים (2020)</h5>", unsafe_allow_html=True)
	      st.markdown("<h5 style='text-align: right;'>(3)רועי גולדשמידט אפליה אלגוריתמית במערכות המבוססות על בינה מלאכותית (הכנסת, מרכז המחקר והמידע, 2020) (2020)</h5>", unsafe_allow_html=True)
              st.markdown("<h5 style='text-align: right;'>(4)שם (2020)</h5>", unsafe_allow_html=True)
	      st.markdown("<h5 style='text-align: right;'>(5)שם (2020)</h5>", unsafe_allow_html=True)
